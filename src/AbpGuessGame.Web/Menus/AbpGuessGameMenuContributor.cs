...
namespace AbpGuessGame.Web.Menus;
public class AbpGuessGameMenuContributor : IMenuContributor
{
    ...
    {
        var l = context.GetLocalizer<AbpGuessGameResource>();
        //Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                AbpGuessGameMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 1
