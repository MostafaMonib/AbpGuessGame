...
{
    [DbContext(typeof(AbpGuessGameDbContext))]
    [Migration("20260905034328_Remove_Game_RowVersion")]
    partial class Remove_Game_RowVersion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpGuessGame.Game", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<int>("BotGuessCount")
            ...
            modelBuilder.Entity("AbpGuessGame.Guess", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GameId", "IdempotencyKey")
                        .IsUnique()
                        .HasFilter("\"IdempotencyKey\" IS NOT NULL");

                    b.ToTable("AppGuesses", (string)null);
                });
            ...
            modelBuilder.Entity("AbpGuessGame.Guess", b =>
                {
                    b.HasOne("AbpGuessGame.Game", "Game")
                        .WithMany("Guesses")
