...
public class AbpGuessGameDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AbpGuessGameGlobalFeatureConfigurator.Configure();
        AbpGuessGameModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AbpGuessGameDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AbpGuessGameResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AbpGuessGame");

            options.DefaultResourceType = typeof(AbpGuessGameResource);
        ...
        {
            options.MapCodeNamespace("AbpGuessGame", typeof(AbpGuessGameResource));
        });
    }
}
