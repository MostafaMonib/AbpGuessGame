...
[DependsOn(
    ...
    typeof(AbpGuessGameWebModule),
    typeof(AbpGuessGameApplicationTestModule),
    typeof(AbpGuessGameEntityFrameworkCoreTestModule)
)]
public class AbpGuessGameWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(AbpGuessGameWebModule).Assembly));
        });
